...
This guide explains how to build Electrum-KickSoccer binaries for macOS systems.
...
#### 1.2 Build Electrum-KickSoccer

    cd electrum-kicksoccer
    ./contrib/osx/make_osx
    
This creates both a folder named Electrum_KickSoccer.app and the .dmg file.
...
Copy the Electrum-KickSoccer.app directory over and install the dependencies, e.g.:
...
Then you can just invoke `package.sh` with the path to the app:
    ...
    cd electrum-kicksoccer
    ./contrib/osx/package.sh ~/Electrum_KickSoccer.app/

...
APPDIR="$BUILDDIR/electrum-kicksoccer.AppDir"
...
APPIMAGE="$DISTDIR/electrum-kicksoccer-$VERSION-x86_64.AppImage"
...
info "preparing electrum-kicksoccer-locale."
(
...
cp "$PROJECT_ROOT/electrum-kicksoccer.desktop" "$APPDIR/electrum-kicksoccer.desktop"
